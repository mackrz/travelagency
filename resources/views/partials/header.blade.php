<head>
        ...
        <script type='text/javascript' src="{{ asset('/js/jquery/unitegallery/js/jquery-11.0.min.js') }}"></script>	
        <script type='text/javascript' src="{{ asset('/js/jquery/unitegallery/js/unitegallery.min.js') }}"></script>	
